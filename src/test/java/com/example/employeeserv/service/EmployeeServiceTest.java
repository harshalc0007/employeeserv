...
import com.example.employeeserv.repository.EmployeeRepository;
...
public class EmployeeServiceTest {
    ...
    public void testSaveEmployee() {
        when(employeeRepository.save(any(Employee.class))).thenReturn(getMockEmployee());
    ...
    public void testGetEmployee() {
        when(employeeRepository.get(any(Integer.class))).thenReturn(getMockEmployee());
